  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        >
          <div className="w-16 h-16 rounded-2xl bg-terminal-bg-light flex items-center justify-center mx-auto mb-4">
            <Newspaper className="w-8 h-8 text-terminal-dim/60" />
          </div>
          <h3 className="text-lg font-medium mb-2">No News Found</h3>
          <p className="text-terminal-dim text-sm mb-6 max-w-md mx-auto">
            {filter === 'all' 
              ? 'No news articles available at the moment. Try refreshing or check back later.'
              : `No ${filter} news articles found. Try clearing the filter to see all news.`}
          </p>
          
          {/* Filter Status */}
          {filter !== 'all' && (
            <div className="flex items-center justify-center gap-2 mb-4">
              <span className="text-xs text-terminal-dim">Current filter:</span>
              <span className={`px-2 py-1 rounded text-xs font-medium ${
                filter === 'positive' ? 'bg-terminal-green/20 text-terminal-green' :
                filter === 'negative' ? 'bg-terminal-red/20 text-terminal-red' :
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <motion.button
              ...
              className="px-4 py-2 rounded-lg bg-terminal-bg-light text-terminal-text text-sm font-medium flex items-center gap-2"
            >
